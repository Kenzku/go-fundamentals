...
func main() {
	...
	// the "loop_label" here is just a label, it can be anything
loopLabel:
	// infinite loop
	for {
		...
		// in GO, it does not fall through from case to case:
		//
		// switch initializer; test expression {
		//    case expression1:
		//		statements // does not fall to the next case
		//	  case expression1, expression3:
		//		statements
		//	  default:
		//		statements
		// }
		// where the initializer; is optional like in if-statement
